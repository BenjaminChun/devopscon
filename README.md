...
## This repository contains basic Maven project with Hello-World Java war for CI/CD workshop AND workshop slides that I covered during the various DevOpsCon(s)
